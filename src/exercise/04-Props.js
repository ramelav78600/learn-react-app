...
function CompanyProfile(props) {
    ...
    const companyProfileInfo = props.company; //✏️ Instead of empty object we want to get this value from props
    return (
        <div>
...
function FBCompanyProfile() {
     ...
     * */
    return (
        <CompanyProfile ticker={stockTicker} company={companyProfileInfo}/>
    )
}
